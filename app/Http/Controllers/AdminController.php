...
class AdminController extends Controller
{
    public function getIndex(){
      ...
      $total_rented_rooms = Motelroom::where('is_rented', 1)->count();
    $total_available_rooms = Motelroom::where('is_rented', 0)->count();
      $reports = Reports::all();
