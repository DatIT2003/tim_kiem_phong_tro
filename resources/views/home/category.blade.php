    ...
    <div class="row room-hot">
        @foreach($listmotel as $room)
            ...
            <div class="col-md-4 col-sm-6">
                <div class="room-item">
                    <div class="wrap-img">
                        <a href="{{ url('phongtro/' . $room->slug) }}">
                            <div style="background: url(uploads/images/{{ $img_thumb[0] }}) center; background-size: cover; height: 250px;"></div>
                        </a>
                        <div class="category">
