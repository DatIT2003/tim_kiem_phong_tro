		...
		<div class="col-md-8">
          ...
          @if(Auth::user()->tinhtrang != 0)
            ...
            <input type="hidden" name="_token" value="{{ csrf_token() }}">
              ...
              <input type="text" id="location-text-box" name="txtaddress" class="form-control" value="" placeholder="Nhập địa chỉ phòng trọ" />
     ...
     <div class="contactpanel">
      <div class="row">
       <div class="col-md-4 text-center">
        <img src="assets/images/hi.jpg" class="img-circle" alt="Cinque Terre" width="100" height="100"> 
      </div>
      <div class="col-md-8">
