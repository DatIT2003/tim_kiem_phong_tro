					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<!-- <li><a href="{{ route('motelrooms.available') }}"><i class="icon-home"></i><span> Danh sách phòng còn trống</span></a></li> -->
								<!-- <li><a href="{{ route('motelrooms.rented') }}"><i class="icon-home"></i><span> Danh sách phòng đã thuê</span></a></li> -->
